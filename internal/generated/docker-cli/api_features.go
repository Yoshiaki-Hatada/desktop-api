...
type FeaturesApi interface {
	 ...
	 */
	GetFeatures(ctx _context.Context) ApiGetFeaturesRequest

	/*
	 * GetFeaturesExecute executes the request
	 * @return FeaturesModel
	 */
	GetFeaturesExecute(r ApiGetFeaturesRequest) (FeaturesModel, *_nethttp.Response, error)
}
...
func (r ApiGetFeaturesRequest) Execute() (FeaturesModel, *_nethttp.Response, error) {
 ...
 * @return ApiGetFeaturesRequest
 */
func (a *FeaturesApiService) GetFeatures(ctx _context.Context) ApiGetFeaturesRequest {
	return ApiGetFeaturesRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return FeaturesModel
 */
func (a *FeaturesApiService) GetFeaturesExecute(r ApiGetFeaturesRequest) (FeaturesModel, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  FeaturesModel
	)
